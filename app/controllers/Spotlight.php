    ...
    public function index() {
        ...
        if(is_logged_in()) {
            ...
            if(user()->type == 1) {
                ...
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' . sprintf(l('admin_settings.title'), l('admin_settings.notifications.tab')),
                ...
                $available_pages[] = [
                    'name' => l('global.menu.admin') . ' - ' .  l('admin_notifications.menu'),
