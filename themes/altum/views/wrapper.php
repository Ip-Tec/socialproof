...
<html lang="<?= \Altum\Language::$code ?>" dir="<?= l('direction') ?>">
    ...
    <body class="<?= l('direction') == 'rtl' ? 'rtl' : null ?> <?= \Altum\Router::$controller_settings['body_white'] ? 'bg-white' : null ?> <?= \Altum\ThemeStyle::get() == 'dark' ? 'cc--darkmode' : null ?>" data-theme-style="<?= \Altum\ThemeStyle::get() ?>">
