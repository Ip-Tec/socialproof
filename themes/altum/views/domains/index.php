    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-lg-auto d-flex flex-wrap gap-3 d-print-none">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('domain-create') ?>" class="btn btn-primary"><i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('domains.create') ?></a>
                <?php endif ?>
            </div>
                    ...
                    <?php foreach($data->domains as $row): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap text-muted">
                                <a href="<?= url('campaigns?domain_id=' . $row->domain_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('campaigns.title') ?>">
