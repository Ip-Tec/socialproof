...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fas fa-fw fa-xs fa-pager text-primary-900 mr-2"></i> <?= l('admin_campaigns.header') ?></h1>
        ...
        <div>
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right d-print-none">
                    <a href="<?= url('admin/campaigns?' . $data->filters->get_get() . '&export=csv') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->csv ? null : 'disabled' ?>">
                        <i class="fas fa-fw fa-sm fa-file-csv mr-2"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                    </a>
                    <a href="<?= url('admin/campaigns?' . $data->filters->get_get() . '&export=json') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->json ? null : 'disabled' ?>">
                ...
                <td class="text-nowrap">
                    <div class="d-flex flex-column">
                        ...
                        <div class="small text-muted">
                            <img referrerpolicy="no-referrer" src="<?= get_favicon_url_from_domain($row->domain) ?>" class="img-fluid icon-favicon-small mr-1" loading="lazy" />

                            <?= $row->domain ?>

                            <a href="<?= 'https://' . $row->domain ?>" rel="noreferrer"><i class="fas fa-fw fa-xs fa-external-link-alt text-muted ml-1"></i></a>
                        </div>
                    </div>
                </td>
                <td class="text-nowrap">
                ...
                <td class="text-nowrap">
                    <div class="d-flex align-items-center">
                        <a href="<?= url('admin/notifications?campaign_id=' . $row->campaign_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_notifications.menu') ?>">
                            <i class="fas fa-fw fa-window-maximize text-muted"></i>
                        </a>
                    </div>
                </td>
