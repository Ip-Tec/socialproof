        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= $data->method == 'notifications' ? 'active' : null ?>" href="<?= url('admin/settings/notifications') ?>"><i class="fas fa-fw fa-sm fa-window-maximize mr-2"></i> <?= l('admin_settings.notifications.tab') ?></a>
