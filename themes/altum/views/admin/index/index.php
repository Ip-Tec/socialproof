            ...
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_campaigns.menu') ?></small>
                    </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/campaigns') ?>" class="stretched-link text-reset text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_notifications.menu') ?></small>
                    </div>

                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-window-maximize text-primary"></i>
                    </span>
                    </div>
                </div>

                <div class="mt-2 text-break">
                    <a href="<?= url('admin/notifications') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="notifications">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="notifications_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.track_notifications') ?></small>
                    </div>

                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-wifi text-primary"></i>
                    </span>
                    </div>
                </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/notifications') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="track_notifications">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="track_notifications_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.track_logs') ?></small>
                    </div>

                    <div class="col-auto">
                    <span class="p-2 bg-primary-100 rounded">
                        <i class="fas fa-fw fa-sm fa-project-diagram text-primary"></i>
                    </span>
                    </div>
                </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/notifications') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="track_logs">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="track_logs_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col text-truncate">
                        <small class="text-muted font-weight-bold"><?= l('admin_index.track_conversions') ?></small>
                    </div>
                ...
                <div class="mt-2 text-break">
                    <a href="<?= url('admin/notifications') ?>" class="stretched-link text-reset text-decoration-none">
                        <span class="h4" id="track_conversions">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                    </a>

                    <div class="mt-1 small text-muted">
                        <span id="track_conversions_current_month">
                            <span class="spinner-border spinner-border-sm" role="status"></span>
                        </span>
                        <?= mb_strtolower(l('global.date.this_month')) ?>
                    </div>
    ...
    <script>
        (async function fetch_statistics() {
            ...
            if(data.status == 'error') {
                ...
                document.querySelector('#notifications').innerHTML = data.details.notifications ? nr(data.details.notifications) : 0;
                document.querySelector('#notifications_current_month').innerHTML = data.details.notifications_current_month ? nr(data.details.notifications_current_month) : 0;

                document.querySelector('#track_notifications').innerHTML = data.details.track_notifications ? nr(data.details.track_notifications) : 0;
                document.querySelector('#track_notifications_current_month').innerHTML = data.details.track_notifications_current_month ? nr(data.details.track_notifications_current_month) : 0;

                document.querySelector('#track_logs').innerHTML = data.details.track_logs ? nr(data.details.track_logs) : 0;
                document.querySelector('#track_logs_current_month').innerHTML = data.details.track_logs_current_month ? nr(data.details.track_logs_current_month) : 0;

                document.querySelector('#track_conversions').innerHTML = data.details.track_conversions ? nr(data.details.track_conversions) : 0;
                document.querySelector('#track_conversions_current_month').innerHTML = data.details.track_conversions_current_month ? nr(data.details.track_conversions_current_month) : 0;
