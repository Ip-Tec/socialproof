...
<div class="form-group custom-control custom-switch">
    ...
    >
    <label class="custom-control-label" for="show_angry"><?= l('notification.settings.show_angry') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    ...
    >
    <label class="custom-control-label" for="show_sad"><?= l('notification.settings.show_sad') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    ...
    >
    <label class="custom-control-label" for="show_neutral"><?= l('notification.settings.show_neutral') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    ...
    >
    <label class="custom-control-label" for="show_happy"><?= l('notification.settings.show_happy') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    ...
    >
    <label class="custom-control-label" for="show_excited"><?= l('notification.settings.show_excited') ?></label>
</div>
