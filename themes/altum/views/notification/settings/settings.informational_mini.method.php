...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .altumcode-informational-mini-title').text($(event.currentTarget).val());
    });

    $('#settings_image').on('change paste keyup', event => {
        $('#notification_preview .altumcode-informational-mini-image').attr('src', $(event.currentTarget).val());
    });
    ...
    settings_title_color_pickr.on('change', hsva => {
        ...
        $('#notification_preview .altumcode-informational-mini-title').css('color', hsva.toHEXA().toString());
    });
