...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_share_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('notification.settings.share_url') ?></label>
        <input type="url" id="settings_share_url" name="share_url" class="form-control" value="<?= $data->notification->settings->share_url ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="2048" />
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="share_facebook"><i class="fab fa-fw fa-facebook"></i> <?= l('notification.settings.share_facebook') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        <input
                ...
                id="share_threads"
                name="share_threads"
            <?= $data->notification->settings->share_threads ? 'checked="checked"' : null ?>
        >
        <label class="custom-control-label" for="share_threads"><i class="fab fa-fw fa-threads"></i> <?= l('notification.settings.share_threads') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        >
        <label class="custom-control-label" for="share_linkedin"><i class="fab fa-fw fa-linkedin"></i> <?= l('notification.settings.share_linkedin') ?></label>
    </div>
...
<div class="form-group custom-control custom-switch">
    ...
    >
    <label class="custom-control-label" for="share_pinterest"><i class="fab fa-fw fa-pinterest"></i> <?= l('notification.settings.share_pinterest') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    ...
    >
    <label class="custom-control-label" for="share_reddit"><i class="fab fa-fw fa-reddit"></i> <?= l('notification.settings.share_reddit') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    <input
            ...
            id="share_x"
            name="share_x"
        <?= $data->notification->settings->share_x ? 'checked="checked"' : null ?>
    >
    <label class="custom-control-label" for="share_x"><i class="fab fa-fw fa-twitter"></i> <?= l('notification.settings.share_x') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    <input
            ...
            id="share_tumblr"
            name="share_tumblr"
        <?= $data->notification->settings->share_tumblr ? 'checked="checked"' : null ?>
    >
    <label class="custom-control-label" for="share_tumblr"><i class="fab fa-fw fa-tumblr"></i> <?= l('notification.settings.share_tumblr') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    ...
    >
    <label class="custom-control-label" for="share_telegram"><i class="fab fa-fw fa-telegram"></i> <?= l('notification.settings.share_telegram') ?></label>
</div>
...
<div class="form-group custom-control custom-switch">
    <input
            ...
            id="share_whatsapp"
            name="share_whatsapp"
        <?= $data->notification->settings->share_whatsapp ? 'checked="checked"' : null ?>
    >
    <label class="custom-control-label" for="share_whatsapp"><i class="fab fa-fw fa-whatsapp"></i> <?= l('notification.settings.share_whatsapp') ?></label>
</div>
