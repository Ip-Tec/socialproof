...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_countdown_end_date"><i class="fas fa-fw fa-sm fa-hourglass-end text-muted mr-1"></i> <?= l('notification.settings.countdown_end_date') ?></label>
        <input type="text" id="settings_countdown_end_date" name="countdown_end_date" class="form-control" value="<?= \Altum\Date::get($data->notification->settings->countdown_end_date, 1) ?>" autocomplete="off" required="required" />
    </div>
...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_time_color"><?= l('notification.settings.time_color') ?></label>
        <input type="hidden" id="settings_time_color" name="time_color" class="form-control" value="<?= $data->notification->settings->time_color ?>" />
        <div id="settings_time_color_pickr"></div>
    </div>

    <div class="form-group">
        <label for="settings_time_background_color"><?= l('notification.settings.time_background_color') ?></label>
        <input type="hidden" id="settings_time_background_color" name="time_background_color" class="form-control" value="<?= $data->notification->settings->time_background_color ?>" />
...
<script>
    ...
    $('#settings_countdown_end_date').daterangepicker({
        minDate: new Date(),
        singleCalendar: true,
        timePicker: true,
