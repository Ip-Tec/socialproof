...
<?php else: ?>
    ...
    <?php if($data->top_pages_result->num_rows): ?>
        ...
        <h2 class="h4 mt-5"><?= l('notification.statistics.header_top_pages') ?></h2>
        ...
        <div class="table-responsive table-custom-container">
            <table class="table table-custom">
                ...
                <tr>
                    <th><?= l('global.url') ?></th>
                    <th><?= l('global.type') ?></th>
                    <th><?= l('notification.statistics.pageviews') ?></th>
                </tr>
                </thead>
                <tbody>
                ...
                <?php while($row = $data->top_pages_result->fetch_object()): ?>
                    ...
                    <tr>
                        <td class="text-nowrap">
                            <img referrerpolicy="no-referrer" src="<?= get_favicon_url_from_domain($row->url) ?>" class="img-fluid icon-favicon mr-1" loading="lazy" />

                            <?= string_truncate(remove_url_protocol_from_url($row->url), 64) ?>

                            <a href="<?= $row->url ?>" target="_blank" rel="nofollow noopener" class="text-muted ml-1"><i class="fas fa-fw fa-xs fa-external-link-alt"></i></a>
                        </td>

                        <td class="text-nowrap">
                            <span class="badge badge-dark"><?= l('notification.statistics.' . $row->type) ?></span>
                        </td>
